...
<html lang="en">
  <head>
    ...
    <title>VSAB | Personal Information</title>
  </head>
  <body>
...
<!---Test-->
    ...
    <form>
        <fieldset active>
          ...
          <div class="mb-3">
            <div class="inputboxforsignup">
            <label for="activeTextInput" class="form-label">Username:</label>
            <input type="text" id="activeTextInput" class="form-control" placeholder="Enter Username">
          </div>
            </div>
          <div class="mb-3">
            <div class="inputboxforsignup">
            <label for="activeTextInput" class="form-label">Password:</label>
          ...
          <div class="mb-3">
            <div class="form-check">
              ...
              <label class="form-check-label" for="activeFieldsetCheck">
                I agree that I am THAT certified freak that is trying to sign in.
              </label>
            </div>
          </div>
